...
public class MappingService {
    public Movie convertDTOToMovie(AddMovieDTO dto){
        return new Movie(0, dto.getTitle(), dto.getPublishYear(), dto.getRated(),
                ...
                dto.getCountry(), dto.getAwards(), dto.getPoster(), dto.getMetascore(), dto.getImdbRating(), dto.getImdbVotes(),
                dto.getImdbID(), dto.getType(), dto.getTotalSeasons(), dto.getComingSoon());
    }
}
